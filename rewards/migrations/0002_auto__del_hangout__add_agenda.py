...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Hangout'
        db.delete_table(u'rewards_hangout')

        # Adding model 'Agenda'
        db.create_table(u'rewards_agenda', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['zinnia.Entry'], unique=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('agenda_type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('admin_note', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('extra', self.gf('forum.models.utils.PickledObjectField')(null=True)),
        ))
        db.send_create_signal(u'rewards', ['Agenda'])


    def backwards(self, orm):
        # Adding model 'Hangout'
        db.create_table(u'rewards_hangout', (
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('admin_note', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'rewards', ['Hangout'])

        # Deleting model 'Agenda'
        db.delete_table(u'rewards_agenda')
