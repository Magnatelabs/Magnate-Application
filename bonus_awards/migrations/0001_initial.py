...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BonusAward'
        db.create_table(u'bonus_awards_bonusaward', (
        ...
        db.send_create_signal(u'bonus_awards', ['BonusAward'])


    def backwards(self, orm):
        # Deleting model 'BonusAward'
        db.delete_table(u'bonus_awards_bonusaward')
    ...
    models = {
        ...
        u'bonus_awards.bonusaward': {
            'Meta': {'object_name': 'BonusAward'},
