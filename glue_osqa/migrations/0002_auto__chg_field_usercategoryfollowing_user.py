...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserCategoryFollowing.user'
        db.alter_column(u'glue_osqa_usercategoryfollowing', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.User']))

    def backwards(self, orm):

        # Changing field 'UserCategoryFollowing.user'
        db.alter_column(u'glue_osqa_usercategoryfollowing', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
