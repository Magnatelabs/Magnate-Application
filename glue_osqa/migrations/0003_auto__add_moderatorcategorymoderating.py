...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModeratorCategoryModerating'
        db.create_table(u'glue_osqa_moderatorcategorymoderating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('moderator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='moderating', to=orm['forum.User'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='moderators', to=orm['zinnia.Category'])),
        ))
        db.send_create_signal(u'glue_osqa', ['ModeratorCategoryModerating'])


    def backwards(self, orm):
        # Deleting model 'ModeratorCategoryModerating'
        db.delete_table(u'glue_osqa_moderatorcategorymoderating')
    ...
    models = {
        ...
        u'glue_osqa.moderatorcategorymoderating': {
            'Meta': {'object_name': 'ModeratorCategoryModerating'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'moderators'", 'to': "orm['zinnia.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'moderating'", 'to': "orm['forum.User']"})
        },
        u'glue_osqa.usercategoryfollowing': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'following'", 'to': "orm['forum.User']"})
        },
        u'sites.site': {
