                    ...
                    <div class="navbar-inner">
                        <div class="container">
                            {% block topbar %}
                                ...
                                {% block site_brand %}<a class="brand" href="{% url "home" %}" title="MAGNATE"><img src="{% static "img/logo.png" %}" alt="MAGNATE" /></a>{% endblock %}
            ...
            {% block body_base %}
                <div class="container">
					...
					<div class="indexdivider"></div>
                        <footer>
                            {% block footer %}
                            <! Above django tag refers to the _footer template>
                            {% endblock %}
                        </footer>
                    {% endblock %}
                </div>
