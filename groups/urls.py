...
urlpatterns = patterns("",
  ...
  url(r"^(?P<id>\d+)/home/$", "groups.views.groups_detail_home", name="category_home_page"),
  url(r"^(?P<id>\d+)/info/$", "groups.views.groups_detail_information", name="groups_detail_info"),
