...
def ajax_list_signup(request):
    ...
    if form.is_valid():
        ...
        try:
            ...
            return redirect("/startedsurvey/started_survey/")
# (just trying out another form)           return redirect("/testform/testform/formtest.html")

#            data = {
#                "html": render_to_string("testFormApp/formtest.html", {  
#                "html": render_to_string("questionnaire.html", {
#                "html": render_to_string("waitinglist/_success.html", {
#                },  context_instance=RequestContext(request))
#            }
    else:
        data = {
            "html": render_to_string("waitinglist/_errors.html", {
                "form": form,
            },  context_instance=RequestContext(request))
        }
