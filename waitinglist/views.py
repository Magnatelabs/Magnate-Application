...
#    import pdb; pdb.set_trace()
    ...
    if form.is_valid():      # Essentially validate the email address that the user entered
        ...
        # entry is just an instance of WaitingListEntry that's been saved to db, has our email just entered
...
#        except SurveyInstance.DoesNotExist:
 #          print 'debug: redirecting to started_survey...'

        return redirect("/startedsurvey/started_survey/?email=" + entry.email)
