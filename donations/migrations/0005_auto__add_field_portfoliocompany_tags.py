...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortfolioCompany.tags'
        db.add_column(u'donations_portfoliocompany', 'tags',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortfolioCompany.tags'
        db.delete_column(u'donations_portfoliocompany', 'tags')
