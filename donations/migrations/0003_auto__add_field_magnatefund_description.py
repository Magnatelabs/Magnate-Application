...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MagnateFund.description'
        db.add_column(u'donations_magnatefund', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MagnateFund.description'
        db.delete_column(u'donations_magnatefund', 'description')
