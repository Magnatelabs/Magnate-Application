...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.objective'
        db.add_column(u'donations_donation', 'objective',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rewards.Agenda'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.objective'
        db.delete_column(u'donations_donation', 'objective_id')
    ...
    models = {
        ...
        u'donations.donation': {
            ...
            'entry': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['zinnia.Entry']", 'unique': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'objective': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rewards.Agenda']", 'null': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'transaction_id': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'donations.magnatefund': {
            'Meta': {'object_name': 'MagnateFund'},
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'donations.portfoliocompany': {
            'Meta': {'object_name': 'PortfolioCompany'},
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'fund': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['donations.MagnateFund']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rewards.agenda': {
            ...
            'admin_note': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'agenda_type': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'entry': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['zinnia.Entry']", 'unique': 'True', 'blank': 'True'}),
            'extra': ('forum.models.utils.PickledObjectField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
