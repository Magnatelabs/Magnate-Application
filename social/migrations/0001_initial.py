...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_starrating', (
        ...
        db.send_create_signal(u'social', ['StarRating'])

        # Adding model 'Like'
        db.create_table(u'social_like', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likes', to=orm['auth.User'])),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zinnia.Entry'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'social', ['Like'])


    def backwards(self, orm):
        # Deleting model 'StarRating'
        db.delete_table(u'social_starrating')

        # Deleting model 'Like'
        db.delete_table(u'social_like')
