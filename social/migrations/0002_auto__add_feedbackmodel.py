...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_feedbackmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('feedback_paragraph', self.gf('django.db.models.fields.TextField')(max_length=750)),
        ))
        db.send_create_signal(u'social', ['FeedbackModel'])


    def backwards(self, orm):
        # Deleting model 'FeedbackModel'
        db.delete_table(u'social_feedbackmodel')
    ...
    models = {
        ...
        u'social.feedbackmodel': {
            'Meta': {'object_name': 'FeedbackModel'},
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'feedback_paragraph': ('django.db.models.fields.TextField', [], {'max_length': '750'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'feedback'", 'to': u"orm['auth.User']"})
        },
        u'social.like': {
            'Meta': {'object_name': 'Like'},
            'count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zinnia.Entry']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
